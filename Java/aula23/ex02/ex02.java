 ...
 * @author vini6
 */
public class ex02 extends FormTemplate {
    ...
    private void initComponents() {
        ...
        jTextArea1.setMaximumSize(new java.awt.Dimension(300, 2147483647));
        ...
        jLabel5.setText("Pedido Minimo");

        jLabel6.setText("Preço Unitário");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Litro", "Onças", "Galão", "metro cubico" }));
